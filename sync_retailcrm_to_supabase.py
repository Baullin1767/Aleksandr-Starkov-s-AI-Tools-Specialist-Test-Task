...
def load_env(env_path: Path) -> Dict[str, str]:
    ...
    # Runtime environment variables override file-based values. This makes the
    # script work both locally with a .env file and on platforms like Vercel
    # where secrets are injected directly into the process environment.
